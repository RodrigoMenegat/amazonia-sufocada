...
def build_thread_7d_grid(data):
    ...
    if not grid_1_ti and not grid_1_uc:
        ...
        tweet = {
            "text": (f"Veja no mapa a região com mais fogo, nos arredores de {grid_1_cidade}, {grid_1_estado}. Essa área está queimando há {grid_1_dias_consecutivos} dias consecutivos. Ao menos parte dela está na unidade de conservação {grid_1_uc}. Pontos amarelos são focos de calor."),
            "img": f"{PROJECT_ROOT}/output/imgs/tweets/grid_7d_mais_fogo_1.jpg"
        }
        tweets.append(tweet)
